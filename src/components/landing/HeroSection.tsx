    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <motion.div
          ...
          className="inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-2xl neural-gradient neural-border mb-6 md:mb-8 animate-float"
        >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full neural-border neural-gradient mb-4 md:mb-6"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-4 md:mb-6"
        >
