...
const ACRY_API_ROUTES = [
  ...
  { group: "Home Dashboard", path: "home-api/todays-mission", method: "GET", desc: "Get today's top priority mission from AI recommendations or at-risk topics", auth: true, request: {}, response: { mission: { id: "uuid", title: "Review: Optics", description: "Memory at 28%", type: "review", priority: "critical", topic_id: "uuid" }, source: "risk_topic" } },
  ...
  { group: "Home Dashboard", path: "home-api/mission-start", method: "POST", desc: "Step 3: Start a brain mission — marks it in_progress and returns action_hint + navigate_to for app routing", auth: true, request: { mission_id: "uuid-of-mission" }, response: { success: true, already_started: false, mission: { id: "uuid", title: "🚨 Rescue: Optics", mission_type: "rescue", priority: "critical", status: "in_progress", target_topic_id: "uuid", target_value: 60, current_value: 28, reward_value: 25, reward_type: "xp" }, started_at: "ISO_DATE", action_hint: "Review the topic to improve your memory_strength", navigate_to: "/study/uuid", message: "🚀 Mission started!" } },
  { group: "Home Dashboard", path: "home-api/mission-questions", method: "POST", desc: "Step 4: Fetch mission questions using mission_id. Automatically resolves the mission's topic and returns AI-generated MCQs.", auth: true, request: { mission_id: "uuid-of-mission", count: 4, difficulty: "medium" }, response: { success: true, mission: { id: "uuid", title: "🚨 Rescue: Optics" }, topic_name: "Optics", subject_name: "Physics", difficulty: "medium", count: 4, questions: [{ question: "What is ...?", options: ["A", "B", "C", "D"], correct_index: 2, explanation: "Because ...", difficulty: "medium" }] } },
  { group: "Home Dashboard", path: "home-api/mission-progress", method: "POST", desc: "Step 5 (Optional): Update progress while user studies. Returns target_reached=true when goal met.", auth: true, request: { mission_id: "uuid", progress_value: 3 }, response: { success: true, mission_id: "uuid", current_value: 3, target_value: 5, target_reached: false, progress_pct: 60, message: "Progress updated: 3/5" } },
  { group: "Home Dashboard", path: "home-api/todays-mission-flow", method: "GET", desc: "Full mission lifecycle guide — returns current state, all 6 flow steps with endpoints, and Flutter code example", auth: true, request: {}, response: { current_state: { has_mission: true, current_mission: {}, completed_today: 1 }, flow_steps: ["6 steps with endpoint details"], flutter_example: { code: "Dart code snippet" } } },
