...
print(profile['data']['display_name']);`} lang="dart" />
      ...
      <div className="glass rounded-xl p-5 neural-border">
        ...
        <div className="space-y-3">
          {[
            { page: "🔐 Authentication Page", route: "/auth", sections: "Email OTP Login/Signup (signInWithOtp → verifyOtp), Google OAuth (lovable.auth.signInWithOAuth), Apple OAuth, Splash Screen, Back to Landing, Toggle Login/Signup", apis: "auth/send-otp, auth/verify-otp, auth/signup, auth/login, auth/refresh-token, auth/session-status, auth/logout", components: "AuthPage.tsx → SplashScreen, OTP Input Grid, Google/Apple OAuth Buttons" },
            { page: "🚀 Onboarding Flow", route: "/onboarding", sections: "Step 1: Display Name, Step 2: Exam Selection (30+ exams across Government/Entrance/Global), Step 3: Exam Date Picker, Step 4: Subject Selection + AI Suggestions, Step 5: Topic Management per Subject + AI Curriculum Generation, Step 6: Study Mode Selection (Chill/Focus/Emergency)", apis: "onboarding/status, onboarding/save-step, onboarding/complete, onboarding/ai-suggest-topics, onboarding/import-syllabus, user/profile/update, subjects/create, topics/create, topics/bulk-create", components: "OnboardingPage.tsx → 6-step wizard, Calendar picker, AI Topic Manager invoke (ai-topic-manager edge function)" },
