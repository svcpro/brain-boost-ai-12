...
const ACRY_API_ROUTES = [
  ...
  { group: "Authentication", path: "msg91-otp/verify", method: "POST", desc: "Verify 4-digit OTP (works for both SMS & WhatsApp). Returns a ready-to-use access token and API key on success.", auth: false, request: { action: "verify", mobile: "919876543210", otp: "1234" }, response: { success: true, verified: true, isNewUser: false, userId: "uuid", access_token: "JWT_TOKEN", refresh_token: "string", api_key: "acry_...", token_type: "bearer" } },
