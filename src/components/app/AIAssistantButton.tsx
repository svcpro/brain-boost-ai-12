      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-[5.5rem] right-4 z-[60] w-14 h-14 rounded-full bg-primary text-primary-foreground flex items-center justify-center glow-primary hover:glow-primary-strong transition-all duration-300 shadow-xl"
          >
