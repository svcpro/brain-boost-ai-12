              ...
              {verifySuccess ? (
                ...
                <>
                  ...
                  <div className="flex items-center gap-3 py-1">
                    ...
                    <span className="text-[10px]" style={{ color: "#ffffff35" }}>or</span>
                    <div className="flex-1 h-px" style={{ background: "#ffffff10" }} />
                  </div>
                  ...
                  <motion.button
                    ...
                    disabled={loading}
                    type="button"
                    className="w-full py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2.5 disabled:opacity-40 transition-all"
                    style={{
                      background: "#ffffff",
                      color: "#1f1f1f",
