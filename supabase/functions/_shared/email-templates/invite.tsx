...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to ACRY — your AI Second Brain</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <Link href={siteUrl} style={link}><strong>ACRY</strong></Link> — the AI-powered exam preparation platform. Accept below to create your account.
        </Text>
        ...
        <Text style={footer}>
          Wasn't expecting this? No action needed — just ignore this email.
        </Text>
      </Container>
    </Body>
  </Html>
